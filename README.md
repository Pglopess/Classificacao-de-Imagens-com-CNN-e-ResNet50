...
O projeto treina e compara diferentes configurações de CNN sobre um dataset de imagens de marcas de tênis, avaliando acurácia de treino e validação. Ao final, compara os resultados com um modelo ResNet50 pré-treinado no ImageNet.
